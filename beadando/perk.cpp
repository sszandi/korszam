...
bool PerkStats::checkOpenGrid(int row, int col) const //perkstats
{
...
int PerkStats::flattenRowColGrid(int row, int col) const // PerkStats-nak is 
{															
	return 1 + (row - 1)*n + (col - 1); 
}
